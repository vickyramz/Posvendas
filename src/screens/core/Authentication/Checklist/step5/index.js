...
const Step5 = (props) => {
  ...
  const selectedAns = (item, index, answer) => {

    console.log("selctedAnswer", item, index ,answer)
      ...
      <TouchableOpacity >
        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 10, height: 100, borderBottomColor: primaryColor, borderBottomWidth: 0.5, width: windowWidth }}>
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 10, flexDirection: 'row' }}>
            <TouchableOpacity onPress={() => selectedAns(item, index, item.opcao1)} style={{ padding: 15, backgroundColor: primaryColor, borderColor: primaryColor, borderWidth: 0.5, }}>
              <Text  style={{ textAlign: 'center' }}>{item.opcao1}</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => selectedAns(item, index, item.opcao2)} style={{ padding: 15, borderColor: primaryColor, borderWidth: 0.5, }}>
