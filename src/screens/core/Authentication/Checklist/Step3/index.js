        ...
        <View style={Styles.mainContainer}>
            <ScrollView showsVerticalScrollIndicator={false} >
                ...
                <View onTouchStart={(e) => { setTextPosition(e) }} style={Styles.BackgroundImageContainer}>
                    <ImageBackground imageStyle={Styles.image} style={Styles.image} source={require('../../../../../assets/vehicle-png-18.png')}></ImageBackground>
                    {TextArray.length > 0 ?
                        TextArray.map((item, index) => {
                            return (
                                <View style={{
                                    position: 'absolute', left: item.left, top: item.top, height: 30, width: 35,
                                    backgroundColor: '#fff',
                                    borderRadius: 3,
                                    borderColor: '#000',
                                    marginLeft: 8,
